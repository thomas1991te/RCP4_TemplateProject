...
/**
 * Each constant refers to a in the preferences persisted value. The constants
 * are used to ease the access to the preference variables and are nothing else
